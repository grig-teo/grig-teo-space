...
export const experienceItems: ExperienceItem[] = [
  ...
  },
  {
    ...
    description: {
      en: 'Microservices with Java/Spring Boot and Node.js — REST & GraphQL APIs, SQL and MongoDB; Azure deployment on an internal project.',
      ru: 'Микросервисы на Java/Spring Boot и Node.js — REST и GraphQL API, SQL и MongoDB; деплой на Azure во внутреннем проекте.',
      ro: 'Microservicii Java/Spring Boot și Node.js — API REST și GraphQL, SQL și MongoDB; deploy Azure într-un proiect intern.',
    },
    summary: {
      en: 'Back-end development in a microservices environment — Java/Spring Boot and Node.js services with REST and GraphQL APIs, SQL and MongoDB data stores, plus Azure deployment on an internal project.',
      ru: 'Back-end разработка в микросервисной архитектуре — сервисы на Java/Spring Boot и Node.js с REST и GraphQL API, SQL и MongoDB, плюс деплой на Azure во внутреннем проекте.',
      ro: 'Dezvoltare back-end într-o arhitectură microservicii — servicii Java/Spring Boot și Node.js cu API REST și GraphQL, SQL și MongoDB, plus deploy Azure într-un proiect intern.',
    },
    highlights: {
      en: [
    ...
    stack: {
      en: 'Java, Spring Boot, Node.js, GraphQL, REST API, microservices, SQL, MongoDB, Azure',
      ru: 'Java, Spring Boot, Node.js, GraphQL, REST API, microservices, SQL, MongoDB, Azure',
      ro: 'Java, Spring Boot, Node.js, GraphQL, REST API, microservicii, SQL, MongoDB, Azure',
    },
  },
  {
    id: 'crossinx',
